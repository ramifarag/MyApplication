...
public class ModeTwoActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        customMapFragment.setOnDragListener(new MapWrapperLayout.OnDragListener() {
            ...
            public void onDrag(MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    DataTransfer[1] = url;
                    Log.d("onClick", url);
                    GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData(ModeTwoActivity.this);
                    getNearbyPlacesData.execute(DataTransfer);
                    Toast.makeText(ModeTwoActivity.this, "Nearby Restaurants", Toast.LENGTH_LONG).show();
                }
            }
        });
...
//        longitude = mapCenter.longitude;
        ...
        Toast.makeText(ModeTwoActivity.this, "Your Current Location", Toast.LENGTH_LONG).show();
